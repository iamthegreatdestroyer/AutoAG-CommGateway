...
import { InvocationTrackerService, InvocationRecord } from '../../src/services/invocation-tracker.service';
...
describe('InvocationTrackerService', () => {
  ...
  describe('Invocation Creation and Tracking', () => {
    ...
    it('should track invocation with user and metadata', () => {
      ...
      const record = tracker.createInvocation('corr-123', 'tool-1', 'server-1', {}, userId, metadata);
