...
import { RollbackService, RollbackRecord, RollbackAction } from '../../src/services/rollback.service';
...
describe('RollbackService', () => {
  ...
  describe('Action Completion', () => {
    ...
    it('should handle string error messages', () => {
      ...
      const updated = rollback.recordActionFailure(rollbackRecord.rollbackId, action.id, 'Rollback failed');
  ...
  describe('Rollback Completion', () => {
    it('should mark rollback as completed when all actions succeed', () => {
      ...
      const action1 = rollback.addRollbackAction(rollbackRecord.rollbackId, 'undo', 'tool-1', {});
      const action2 = rollback.addRollbackAction(rollbackRecord.rollbackId, 'compensate', 'tool-2', {});
