...
describe('MCPServerRepository', () => {
  ...
  describe('search', () => {
    ...
    it('should search servers by name', async () => {
      ...
      expect(
        result.servers.some((s: any) => s.name.includes('weather'))
      ).toBe(true);
    });
    ...
    it('should filter by category', async () => {
      ...
      expect(
        result.servers.every((s: any) => s.category.includes('weather'))
      ).toBe(true);
    });
  ...
  describe('updateRevenue', () => {
    it('should update total revenue', async () => {
      ...
      await db.mcpServers.updateRevenue(server.id, 10.50);
