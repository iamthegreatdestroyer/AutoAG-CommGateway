...
// @ts-expect-error - Calculated but not yet used, kept for future revenue calculations
...
export class CommissionService extends EventEmitter {
  ...
  public resetForTesting(): void {
    ...
    this.invokeCommissions.clear();
    this.serverCommissions.clear();
    this.publisherCommissions.clear();
    this.affiliateCodeMap.clear();
    this.affiliateServerLinks.clear();
    this.cache.clear();
  }
   ...
   */
  private simulateBlockchainTransaction(_batch: PayoutBatch): string {
