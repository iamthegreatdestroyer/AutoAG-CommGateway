...
export class TransactionRepository extends BaseRepository<Transaction> {
  ...
  async findByUser(userId: string, params?: { page?: number; limit?: number }): Promise<Transaction[]> {
  ...
  async findByServer(serverId: string, params?: { page?: number; limit?: number }): Promise<Transaction[]> {
    const { page = 1, limit = 20 } = params || {};
  ...
  async updateStatus(transactionId: string, status: TransactionStatus, metadata?: any): Promise<Transaction> {
